...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--width", type=int, default=320, help="sensor window width; use 0 to keep full frame")
    parser.add_argument("--height", type=int, default=240, help="sensor window height; use 0 to keep full frame")
